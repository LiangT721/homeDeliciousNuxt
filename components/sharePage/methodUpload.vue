  ...
  <div class="font-fonts">
    ...
    <div class="processes w-5/6 mx-auto px-0 py-5 content-start gap-y-3 md:w-3/4">
      ...
      <div class="image text-center m-5">
        ...
        />
        <image-upload v-else @newImage="newImage" />
      </div>
    ...
    <div class="submit-btns flex justify-center" @click="uploadMethod">
      <button class="button">
...
import foodIngredientsEdit from "./foodIngredientsEdit.vue";
import FoodMethodEdit from "./foodMethodEdit.vue";
